...
0.1202 m/ns; at their 0.1200 it moves 5 mm. **Internally consistent, and immaterial to the ties.** The velocity is PARSAN's slab calibration (Table 1) confirmed by the diffraction scan; its residual uncertainty is the 3.2 % ladder term (`tables/uncertainty.json`).
...
| answer | test | result |
| --- | --- | --- |
| RDP 6.25 for all blocks | hyperbola scan, 114 apices below 0.6 m | **6.22, consistent to 0.5 % with the diffraction median and within PARSAN's slab calibration (RDP 6.24 to 6.52); individual fits spread 0.088 to 0.172 m/ns** |
